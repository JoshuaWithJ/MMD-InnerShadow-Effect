...
/////////////////////////////////////////////////////////////////////////////////
texture2D InnerShadowAM_1 : OFFSCREENRENDERTARGET
<
    string Description = "InnerShadow Alpha Mask RT (Uncheck)_1";
	float4 ClearColor = { 0, 0, 0, 0 };
    float ClearDepth = 1.0;
	bool AntiAlias = true;
	int Miplevels = 1;
...
float3 IS1_Pos : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IShad_P_1"; >;
float IS1_R : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IS1_R"; >;
float IS1_G : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IS1_G"; >;
float IS1_B : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IS1_B"; >;
////////////////////////////////////////////////////////////////////////////////////////////////
...
{   
    ...
    float4 AlphaMask = tex2D(AlphaMaskSampler, RTPos1 + float2(-1,0) + (float2(1-IS1_Pos.x/10,IS1_Pos.y/10) ) );
    ...
    float4 color;
    color = float4(IS1_R,IS1_G,IS1_B,1);
