...
/////////////////////////////////////////////////////////////////////////////////
texture2D InnerShadowAM_3 : OFFSCREENRENDERTARGET
<
    string Description = "InnerShadow Alpha Mask RT (Uncheck)_3";
...
float3 IS3_Pos : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IShad_P_3"; >;
float IS3_R : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IS3_R"; >;
float IS3_G : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IS3_G"; >;
float IS3_B : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IS3_B"; >;
////////////////////////////////////////////////////////////////////////////////////////////////
...
{   
    ...
    float4 AlphaMask = tex2D(AlphaMaskSampler, RTPos1 + float2(-1,0) + (float2(1-IS3_Pos.x/10,IS3_Pos.y/10) ) );
    ...
    float4 color;
    color = float4(IS3_R,IS3_G,IS3_B,1);
