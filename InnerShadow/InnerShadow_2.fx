...
/////////////////////////////////////////////////////////////////////////////////
texture2D InnerShadowAM_2 : OFFSCREENRENDERTARGET
<
    string Description = "InnerShadow Alpha Mask RT (Uncheck)_2";
    float4 ClearColor = { 0, 0, 0, 0 };
    float ClearDepth = 1.0;
	bool AntiAlias = true;
	int Miplevels = 1;
...
float3 IS2_Pos : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IShad_P_2"; >;
float IS2_R : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IS2_R"; >;
float IS2_G : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IS2_G"; >;
float IS2_B : CONTROLOBJECT < string name = "InnerShadow - Controller.pmx"; string item = "IS2_B"; >;
////////////////////////////////////////////////////////////////////////////////////////////////
...
{   
    ...
    float4 AlphaMask = tex2D(AlphaMaskSampler, RTPos1 + float2(-1,0) + (float2(1-IS2_Pos.x/10,IS2_Pos.y/10) ) );
    ...
    float4 color;
    color = float4(IS2_R,IS2_G,IS2_B,1);
